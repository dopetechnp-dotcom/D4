-- =====================================================
-- Complete Storage Policies Fix for DopeTech
...
DROP POLICY IF EXISTS "hero_images_authenticated_insert" ON storage.objects;
DROP POLICY IF EXISTS "hero_images_authenticated_update" ON storage.objects;
DROP POLICY IF EXISTS "hero_images_authenticated_delete" ON storage.objects;
...
DROP POLICY IF EXISTS "qr_codes_authenticated_insert" ON storage.objects;
DROP POLICY IF EXISTS "qr_codes_authenticated_update" ON storage.objects;
DROP POLICY IF EXISTS "qr_codes_authenticated_delete" ON storage.objects;
