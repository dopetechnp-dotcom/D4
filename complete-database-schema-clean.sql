-- =====================================================
-- Complete DopeTech Database Schema (CLEAN INSTALL)
...
DROP TABLE IF EXISTS public.category_banners CASCADE;
DROP TABLE IF EXISTS public.payment_qr_codes CASCADE;
...
CREATE INDEX idx_products_hidden_on_home ON public.products(hidden_on_home);
...
CREATE INDEX idx_category_banners_category_id ON public.category_banners(category_id);
CREATE INDEX idx_category_banners_display_order ON public.category_banners(display_order);
...
CREATE INDEX idx_payment_qr_codes_payment_method ON public.payment_qr_codes(payment_method);
CREATE INDEX idx_payment_qr_codes_sort_order ON public.payment_qr_codes(sort_order);
CREATE INDEX idx_payment_qr_codes_is_active ON public.payment_qr_codes(is_active);
